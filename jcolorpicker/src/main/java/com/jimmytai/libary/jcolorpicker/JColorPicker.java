/*
 * Copyright 2016 JimmyTai
 *
 * This library is based on 2012 Lars Werkman HoloColorPicker Library.
 *
...
package com.jimmytai.libary.jcolorpicker;
 ...
 * Use {@link #addSVBar(JSVBar)} to add a Saturation/Value Bar. <br>
 * Use {@link #addOpacityBar(JOpacityBar)} to add a Opacity Bar.
 * </p>
 */
public class JColorPicker extends View {
    /*
     ...
     */
    private static final int[] COLORS = new int[]{0xFFFF00FF,
            0xFF0000FF, 0xFF00FFFF, 0xFF00FF00, 0xFFFFFF00, 0xFFFF0000, 0xFFFF0000};
     ...
     */
    private JValueBar mJValueBar = null;
    ...
    public JColorPicker(Context context) {
        super(context);
        init(null, 0);
    }

    public JColorPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public JColorPicker(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mColorCenterRadius = a.getDimensionPixelSize(
                R.styleable.JColorPicker_color_center_radius,
        ...
        mColorCenterHaloRadius = a.getDimensionPixelSize(
                R.styleable.JColorPicker_color_center_halo_radius,
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mColorCenterHaloRadius = (int) ((float) mPreferredColorCenterHaloRadius * ((float) mColorWheelRadius / (float)
    ...
    public void setColor(int color) {
        ...
        if (mJSaturationBar != null) {
            Color.colorToHSV(color, mHSV);
            mJSaturationBar.setColor(mColor);
            mJSaturationBar.setSaturation(mHSV[1]);
        }

        if (mJValueBar != null && mJSaturationBar == null) {
            Color.colorToHSV(color, mHSV);
            mJValueBar.setColor(mColor);
            mJValueBar.setValue(mHSV[2]);
        } else if (mJValueBar != null) {
            Color.colorToHSV(color, mHSV);
            mJValueBar.setValue(mHSV[2]);
        }
     ...
     */
    public void addSVBar(JSVBar bar) {
        mSVbar = bar;
     ...
     */
    public void addOpacityBar(JOpacityBar bar) {
        mOpacityBar = bar;
    ...
    public void addSaturationBar(JSaturationBar bar) {
        mJSaturationBar = bar;
        mJSaturationBar.setColorPicker(this);
        mJSaturationBar.setColor(mColor);
    }

    public void addValueBar(JValueBar bar) {
        mJValueBar = bar;
        mJValueBar.setColorPicker(this);
        mJValueBar.setColor(mColor);
    }
    ...
    public void changeSaturationBarColor(int color) {
        if (mJSaturationBar != null) {
            mJSaturationBar.setColor(color);
        }
    }
