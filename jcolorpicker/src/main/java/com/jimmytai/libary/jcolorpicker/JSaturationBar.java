...
public class JSaturationBar extends View {
     ...
     */
    private JColorPicker mPicker = null;
    ...
    public JSaturationBar(Context context) {
        super(context);
        init(null, 0);
    }

    public JSaturationBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public JSaturationBar(Context context, AttributeSet attrs, int defStyle) {
     ...
     *
     * @param picker
     * @see com.jimmytai.libary.jcolorpicker.JColorPicker#addSVBar(JSVBar)
     */
    public void setColorPicker(JColorPicker picker) {
        mPicker = picker;
    }
