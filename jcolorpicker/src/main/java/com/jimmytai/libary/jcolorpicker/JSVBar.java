...
public class JSVBar extends View {
	...
	public JSVBar(Context context) {
		super(context);
		init(null, 0);
	}

	public JSVBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public JSVBar(Context context, AttributeSet attrs, int defStyle) {
