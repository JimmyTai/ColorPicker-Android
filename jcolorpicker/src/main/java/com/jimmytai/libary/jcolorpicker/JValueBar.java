...
public class JValueBar extends View {
    ...
    public JValueBar(Context context) {
        super(context);
        init(null, 0);
    }

    public JValueBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public JValueBar(Context context, AttributeSet attrs, int defStyle) {
