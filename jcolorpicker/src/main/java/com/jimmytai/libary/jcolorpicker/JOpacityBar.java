...
public class JOpacityBar extends View {
    ...
    public JOpacityBar(Context context) {
        super(context);
        init(null, 0);
    }

    public JOpacityBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public JOpacityBar(Context context, AttributeSet attrs, int defStyle) {
